...
var require_dexie = __commonJS({
  "node_modules/.pnpm/dexie@4.3.0/node_modules/dexie/dist/dexie.js"(exports, module) {
    "use strict";
...
// node_modules/.pnpm/@panyam+tsappkit@0.0.5/node_modules/@panyam/tsappkit/dist/index.mjs
...
// ../shared/compiler/icons.ts
var svg = (d) => `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="24" height="24"><path d="${d}"/></svg>`;
var ICONS = {
...
// ../shared/compiler/player-engine.ts
var PLAYER_JS = `
(function() {
  'use strict';
...
function compileToHTML(project) {
...
async function serializeSteps(steps) {
  return Promise.all(
...
// lib/scene-db.ts
var db = new import_wrapper_default("lucid-capture");
db.version(1).stores({
...
async function getSteps(projectId) {
  return db.steps.where("[projectId+order]").between([projectId, import_wrapper_default.minKey], [projectId, import_wrapper_default.maxKey]).toArray();
}

// lib/export.ts
function initExportButtons() {
  document.querySelectorAll(".lc-export-btn").forEach(initButton);
}
